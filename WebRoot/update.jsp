    ...
    <div class="logout right"><a href="/p/remove.do" title="注销">注销</a></div>
      ...
      <div class="login logns produce">
        <h1 class="blues">拍卖品信息</h1>
         <form action="/p/update.do" method="post" onsubmit="return checkForm()" enctype="multipart/form-data">
          <dl>
            <dd >
              <label>名称：</label>
            ...
            <dd>
              <label>修改图片：</label>
              <div class="lf salebd"><a href="#"><img src="/p/images/${auction.auction_pic }" width="100" height="100" /></a></div>
