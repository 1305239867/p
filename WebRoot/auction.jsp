	...
	<script type="text/javascript">
		function cclick(price,id) {
			...
			if(pic<=price){
				...
				location = "/p/updatepic.do?auction_id="+id+"&auction_upset="+pic;
				$("#p").html("");
			}
		}
		function checkRefresh(id) {
			location = "/p/selectOnee.do?auction_id="+id;
		}
		function checkMain() {
    ...
    <div class="logout right"><a href="/p/remove.do" title="注销">注销</a></div>
	  ...
	  <div class="items sg-font lf">
	  	...
	  	<div class="rg borders">
	  		<img src="/p/images/${auction.auction_pic }" width="270" height="185" alt="" />
	  	</div>
		<div class="cl"></div>
