...
<!-- main begin-->
 <div class="main">
   <div class="sidebar">
     <p><img src="/p/images/img1.jpg" width="443" height="314" alt="" /></p>
   </div>
   <div class="sidebarg">
     <form action="/p/login.do" method="post" target='_blank'>
    <div class="login">
      <dl>
        ...
        <dd>
           ...
           <span class="wordp lf"><img src="/p/getKaptcha.do" width="96" height="27" id="kaptchaImage"/></span>
